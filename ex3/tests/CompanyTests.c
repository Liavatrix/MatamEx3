...
static bool testUpdateCompanyIncome(){
    ...
    error_code1 = UpdateCompanyIncome(first_company,NULL,0);
    ASSERT_TEST(error_code1==MTM_NULL_PARAMETER);
    error_code1=UpdateCompanyIncome(first_company,order1,1);
    ASSERT_TEST(error_code1==MTM_SUCCESS);
    error_code1=UpdateCompanyIncome(first_company,order2,0);
    ASSERT_TEST(error_code1==MTM_SUCCESS);
    error_code1=UpdateCompanyIncome(first_company,order3,0);
    ASSERT_TEST(error_code1==MTM_SUCCESS);
    error_code1=UpdateCompanyIncome(first_company,order4,1);
